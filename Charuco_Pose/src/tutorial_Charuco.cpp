...
namespace {
const char* about = "A code on charuco board pose estimation with and without camera caliberation";
const char* keys =  "{c        |       | c=0 to detect charuco board without camera calibration;\n c=1 to detect charuco board with camera calibration and Pose Estimation}";
}
